...
export default function Customer() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://www.ianflexity.co.kr/", {
        method: "POST",
...
<Helmet>
  {/* 페이지별 메타 */}
  <title>용인 이안 플렉시티 | 관심고객등록</title>

  <meta
    name="description"
    content="용인 이안 플렉시티 관심고객등록 안내. 용인특례시 처인구 남사읍 아곡리 일원에 조성되는 2,018세대 10년 민간임대 아파트의 공급일정, 모집공고, 계약 일정 및 주요 소식을 가장 먼저 확인하세요."
  />

  <meta
    name="keywords"
    content="용인 이안 플렉시티 관심고객등록, 용인 이안플렉시티, 용인 민간임대 아파트, 용인 10년 민간임대, 용인 처인구 아파트, 남사읍 아파트, 용인 이안 플렉시티 공급일정, 용인 이안 플렉시티 모집공고"
  />
  ...
  <link
    rel="canonical"
    href="https://www.ianflexity.co.kr/Promotion/Customer"
  />
  ...
  <meta
    property="og:title"
    content="용인 이안 플렉시티 | 관심고객등록"
  />

  <meta
    property="og:description"
    content="용인 이안 플렉시티 관심고객 등록으로 공급일정, 모집공고, 계약 일정 등 주요 소식을 가장 먼저 받아보세요."
  />

  <meta
    property="og:url"
    content="https://www.ianflexity.co.kr/Promotion/Customer"
  />

  <meta
    property="og:image"
    content="https://www.ianflexity.co.kr/img/og/customer.jpg"
  />
  ...
  <meta
    ...
    content="용인 이안 플렉시티 관심고객 등록으로 공급일정과 주요 소식을 빠르게 확인하세요."
  />
  ...
  <script type="application/ld+json">
    {JSON.stringify({
      ...
      "name":"용인 이안 플렉시티 - 관심고객등록",

      "url":"https://www.ianflexity.co.kr/Promotion/Customer",

      "description":
      "용인 이안 플렉시티 관심고객등록 페이지입니다. 공급일정, 모집공고, 계약 일정 및 주요 소식을 우선 제공합니다.",

      "primaryImageOfPage":{
        "@type":"ImageObject",
        "contentUrl":"https://www.ianflexity.co.kr/img/og/customer.jpg",
        "width":1200,
        "height":630
      },
      ...
      "breadcrumb":{
        ...
        "itemListElement":[
          ...
          },
          {
            ...
            "position":2,
            "name":"관심고객등록",
            "item":"https://www.ianflexity.co.kr/Promotion/Customer"
          }
        ]
      }
    })}
      ...
      <div className={styles.customerWrap}>
        ...
        <div className={styles.customerLeft}>
          <div className={styles.textBlock}>
            <h2 className={styles.projectName}>용인 이안 플렉시티</h2>
