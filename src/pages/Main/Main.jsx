...
const section3Contents = [
  ...
  },
  {
    ...
    title: "PREMIUM 02",
    text1: `광역 교통망 프리미엄`,
    text2: `국도 45호선 및 광역도로망 접근성<br/>
            편리한 이동 환경과 미래 교통 인프라`,
  ...
  },
  {
    ...
    title: "PREMIUM 03",
    text1: `풍부한 생활 인프라`,
    text2: `생활·상업·교육 인프라를 가까이 누리는<br/>
            더욱 편리한 프리미엄 주거환경`,
    link: "/LocationEnvironment/intro",
    linkText: "더 알아보기 >",
  },
  {
    ...
    title: "PREMIUM 04",
    text1: `2,018세대 대단지 프리미엄`,
    text2: `10년 민간임대 대단지가 선사하는<br/>
            쾌적한 주거환경과 프리미엄 라이프`,
        ...
        <div className={styles.imageContainer}>
          ...
          <div className={styles.mainImageTextSub}>
            ...
            <div className={styles.mainImageTitleBox}>
              ...
              <div className={styles.mainImageDesc}>
                ...
                2,018세대 10년 민간임대 프리미엄 대단지<br/>
                반도체클러스터 미래가치를 품은 새로운 라이프를 만나보세요.
              </div>
            ...
            <div className={styles.section1}>
              <div className={styles.textBox}>
                ...
                <div className={styles.text3}>
                  - 용인 반도체클러스터 미래가치를 품은 프리미엄 입지<br />
                  - 총 2,018세대 10년 민간임대 대단지 프리미엄<br />
                  - 광역도로망과 편리한 교통환경을 갖춘 미래 주거 중심지<br />
                  - 생활·교육·상업 인프라를 가까이 누리는 쾌적한 주거환경<br />
                  - 자연과 함께하는 힐링 라이프와 품격 있는 커뮤니티 설계
                </div>
          ...
          <div className={styles.section}>
            <div className={styles.section4}>
              <div className={styles.imageBox}>
                <img
                  src={section4_Image1}
                  alt="용인 이안 플렉시티브랜드소개-image4"
                  loading="lazy"
                  decoding="async"
                />
                <div className={styles.text1}>용인 이안 플렉시티</div>
          ...
          <div className={styles.pcVisitContainer}>
            ...
            <form
              ...
              action="https://www.ianflexity.co.kr/"
              method="POST"
            >
              <label htmlFor="name">
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              ...
              <img src={map1} alt="용인 이안 플렉시티오시는길안내-image1" />
            </div>
          </div> */}
        ...
        <div className={styles.mobileMain}>
          ...
          <div className={styles.mainImageTitleBox1}>
            ...
            <div className={styles.mainImageDesc1}>
              ...
              반도체클러스터 미래가치를 품은<br/> 새로운 라이프를 제안합니다.
            </div>
          ...
          <div className={styles.container1}>
            ...
            <div className={styles.text3}>
              - 용인 반도체클러스터 개발 수혜를 기대하는 미래가치 프리미엄<br />
              - 총 2,018세대 10년 민간임대 대단지 브랜드 라이프<br />
              - 국도 45호선 등 광역 교통망으로 편리한 이동 환경<br />
              - 생활·교육·상업 인프라를 가까이 누리는 실속 있는 주거환경<br />
              - 자연과 어우러진 쾌적한 단지 설계와 프리미엄 커뮤니티
            </div>
         ...
         <div className={styles.mobileMiddleImage}>
          ...
          <div className={styles.container3}>
            <div className={styles.textbox}>
              ...
              <div className={`${styles.text4} fadeUpRepeat`}>
                살수록 자부심이 차원이 다른
                <br />
                프리미엄 주거라이프를 <br /> 용인 이안 플렉시티에서<br />
                확인하세요
              </div>
            </div>
            <img
              src={section2_Image1}
              alt="용인 이안 플렉시티모바일 조감도 이미지"
              loading="lazy"
              decoding="async"
            />
          </div>
          ...
          {/* <div className={styles.container2}>
            <div>
              <img
                src={section1_Image1}
                alt="용인 이안 플렉시티브랜드소개 mobile-image5"
              />
          ...
          {/* <div className={styles.section}>
            <div className={styles.section9}>
              <img
                src={mobilemap1}
                alt="용인 이안 플렉시티오시는길안내-mobileimage2"
              />
            </div>
          </div> */}
